...
public class EntityNPC extends EntityCreature {
	...
	public String getTexture() {
		return "/maemesoft/texture/" + getNPCType().textureDirectory + "/" + dataWatcher.getWatchableObjectString(4).toLowerCase() + ".png";
	}

	public ModelBase getModel() {
		if (model == null)
			model = Maeme.proxy.getNPCModel(getNPCType(), dataWatcher.getWatchableObjectString(4));
		return model;
	}
