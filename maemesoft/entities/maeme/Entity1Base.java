...
public abstract class Entity1Base extends EntityTameable {
	...
	public void updateNBT() {
		try {
			MaemeStorage.CardManager.getPlayerStorage((EntityPlayerMP) getOwner()).updateNBT((EntityMaeme)this);
	...
	public PlayerStorage getStorage() throws PlayerNotLoadedException{
		return MaemeStorage.CardManager.getPlayerStorage((EntityPlayerMP) getOwner());
	}
