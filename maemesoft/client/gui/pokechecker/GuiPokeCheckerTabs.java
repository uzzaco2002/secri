...
public class GuiPokeCheckerTabs extends GuiButton {
	...
	public GuiPokeCheckerTabs(int type, int par1, int par2, int par3, int par4, int par5, String par6Str, MaemeDataPacket pixelmonData) {
		super(par1, par2, par3, par4, par5, par6Str);
		this.enabled = true;
		this.drawButton = true;
		this.id = par1;
	...
	public void drawButton(Minecraft par1Minecraft, int par2, int par3) {
		if (this.drawButton) {
			...
			if (this.tabType <= 4 || this.tabType == 7)
				par1Minecraft.renderEngine.bindTexture("/maemesoft/gui/summarySummary.png");
			else if (this.tabType == 5)
				par1Minecraft.renderEngine.bindTexture("/maemesoft/gui/yesNo.png");
			else if (this.tabType == 6)
				par1Minecraft.renderEngine.bindTexture("/maemesoft/gui/pokecheckerPopup.png");
			...
			if (getHoverState(field_82253_i) == 2) {
				if (this.tabType == 4)
					...
					this.drawTexturedModalRect(this.xPosition, this.yPosition, 79, 229, this.width, this.height);
	...
	public boolean mousePressed(Minecraft par1Minecraft, int par2, int par3) {
		return this.enabled && this.drawButton && par2 >= this.xPosition && par3 >= this.yPosition && par2 < this.xPosition + this.width
