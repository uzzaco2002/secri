...
public class GuiScreenPokeCheckerWarning extends GuiContainer {
	...
	public GuiScreenPokeCheckerWarning(MaemeDataPacket MaemeDataPacket, int i) {
		super(new ContainerEmpty());
		targetPacket = MaemeDataPacket;
		warningIndex = i;
	}

	public GuiScreenPokeCheckerWarning(MaemeDataPacket MaemeDataPacket, int i, int j) {
		super(new ContainerEmpty());
		targetPacket = MaemeDataPacket;
		warningIndex = i;
		moveToDelete = j;
	...
	public void drawGuiContainerBackgroundLayer(float f, int mouseX, int mouseY) {
		mc.renderEngine.bindTexture("/maemesoft/gui/yesNo.png");
