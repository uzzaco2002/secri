package maemesoft.client.models.discs;

import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;

public class ModelDiscFlat extends ModelBase {
	// fields
	...
	public ModelDiscFlat() {
		textureWidth = 32;
		textureHeight = 32;

		RedTip = new ModelRenderer(this, 18, 0);
		RedTip.addBox(-1F, -1.3F, -1F, 2, 1, 2);
		...
		RedFront.addBox(-1F, -1.2F, -1.9F, 2, 1, 1);
		...
		RedBottom.addBox(-1.5F, -1.2F, -1.5F, 3, 1, 3);
		...
		RedRight.addBox(-1.9F, -1.2F, -1F, 1, 1, 2);
		...
		RedLeft.addBox(0.9F, -1.2F, -1F, 1, 1, 2);
		...
		RedBack.addBox(-1F, -1.2F, 0.9F, 2, 1, 1);
