...
public class MaemeModelRenderer extends ModelRenderer {
	...
	public MaemeModelRenderer(ModelBase par1ModelBase, String par2Str) {
		super(par1ModelBase, par2Str);
	}

	public MaemeModelRenderer(ModelBase par1ModelBase) {
		super(par1ModelBase);
	}

	public MaemeModelRenderer(ModelBase par1ModelBase, int par2, int par3) {
