...
import maemesoft.items.heldItems.ChoiceItem;
import maemesoft.items.heldItems.EVAdjusting;
import maemesoft.items.heldItems.ItemBerryOran;
import maemesoft.items.heldItems.ItemEverstone;
...
public class MaemeItemsHeld {
	...
	public static void addNames() {
		try {
			for (Field field : MaemeItemsHeld.class.getFields()) {
