...
import maemesoft.items.ItemPokeBall;
...
public class MaemeItemsPokeballs {
	...
	@Mod.Item(name = "Poke Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item pokeBall;
	@Mod.Item(name = "Great Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item greatBall;
	@Mod.Item(name = "Ultra Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item ultraBall;
	@Mod.Item(name = "Master Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item masterBall;
	@Mod.Item(name = "Level Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item levelBall;
	@Mod.Item(name = "Moon Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item moonBall;
	@Mod.Item(name = "Friend Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item friendBall;
	@Mod.Item(name = "Love Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item loveBall;
	@Mod.Item(name = "Safari Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item safariBall;
	@Mod.Item(name = "Heavy Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item heavyBall;
	@Mod.Item(name = "Fast Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item fastBall;
	@Mod.Item(name = "Repeat Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item repeatBall;
	@Mod.Item(name = "Timer Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item timerBall;
	@Mod.Item(name = "Nest Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item nestBall;
	@Mod.Item(name = "Net Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item netBall;
	@Mod.Item(name = "Dive Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item diveBall;
	@Mod.Item(name = "Luxury Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item luxuryBall;
	@Mod.Item(name = "Heal Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item healBall;
	@Mod.Item(name = "Dusk Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item duskBall;
	@Mod.Item(name = "Premier Ball", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item premierBall;

	@Mod.Item(name = "Poke Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item pokeBallLid;
	@Mod.Item(name = "Great Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item greatBallLid;
	@Mod.Item(name = "Ultra Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item ultraBallLid;
	@Mod.Item(name = "Level Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item levelBallLid;
	@Mod.Item(name = "Moon Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item moonBallLid;
	@Mod.Item(name = "Friend Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item friendBallLid;
	@Mod.Item(name = "Love Ball Lid", typeClass = "maemesoft.items.ItemPokeBallLid")
	public static Item loveBallLid;
	@Mod.Item(name = "Safari Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item safariBallLid;
	@Mod.Item(name = "Heavy Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item heavyBallLid;
	@Mod.Item(name = "Fast Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item fastBallLid;
	@Mod.Item(name = "Repeat Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item repeatBallLid;
	@Mod.Item(name = "Timer Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item timerBallLid;
	@Mod.Item(name = "Nest Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item nestBallLid;
	@Mod.Item(name = "Net Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item netBallLid;
	@Mod.Item(name = "Dive Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item diveBallLid;
	@Mod.Item(name = "Luxury Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item luxuryBallLid;
	@Mod.Item(name = "Heal Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item healBallLid;
	@Mod.Item(name = "Dusk Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item duskBallLid;
	@Mod.Item(name = "Premier Ball Lid", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item premierBallLid;

	@Mod.Item(name = "Poke Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item pokeBallDisc;
	@Mod.Item(name = "Great Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item greatBallDisc;
	@Mod.Item(name = "Ultra Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item ultraBallDisc;
	@Mod.Item(name = "Level Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item levelBallDisc;
	@Mod.Item(name = "Moon Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item moonBallDisc;
	@Mod.Item(name = "Friend Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item friendBallDisc;
	@Mod.Item(name = "Love Ball Disc", typeClass = "maemesoft.items.ItemPokeBallDisc")
	public static Item loveBallDisc;
	@Mod.Item(name = "Safari Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item safariBallDisc;
	@Mod.Item(name = "Heavy Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item heavyBallDisc;
	@Mod.Item(name = "Fast Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item fastBallDisc;
	@Mod.Item(name = "Repeat Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item repeatBallDisc;
	@Mod.Item(name = "Timer Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item timerBallDisc;
	@Mod.Item(name = "Nest Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item nestBallDisc;
	@Mod.Item(name = "Net Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item netBallDisc;
	@Mod.Item(name = "Dive Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item diveBallDisc;
	@Mod.Item(name = "Luxury Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item luxuryBallDisc;
	@Mod.Item(name = "Heal Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item healBallDisc;
	@Mod.Item(name = "Dusk Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item duskBallDisc;
	@Mod.Item(name = "Premier Ball Disc", typeClass = "maemesoft.items.ItemPokeBall")
	public static Item premierBallDisc;

	@Mod.Item(name = "Iron Disc", typeClass = "maemesoft.items.MaemeItem")
	public static Item ironDisc;
	@Mod.Item(name = "Iron Base", typeClass = "maemesoft.items.MaemeItem")
	...
	public static void addNames() {
		try {
			for (Field field : MaemeItemsPokeballs.class.getFields()) {
