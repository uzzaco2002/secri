...
public class MaemeItemsFossils {
	...
	public static void load(Configuration cfg) {
		...
		fossilMachineItem = new ItemBlock(fossilMachineItemID, MaemeBlocks.fossilMachine, "fossilmachine", "Fossil Machine");
		fossilCleanerItem = new ItemBlock(fossilCleanerItemID, MaemeBlocks.fossilCleaner, "fossilcleaner", "Fossil Cleaner");
		...
		fossilMachineTank = new MaemeItem(fossilMachineTankID, "blocks/fossilmachinetank", "Fossil Machine Tank").setCreativeTab(CreativeTabs.tabDecorations);
		fossilMachineDisplay = new MaemeItem(fossilMachineDisplayID, "blocks/fossilmachinedisplay", "Fossil Machine Display").setCreativeTab(CreativeTabs.tabDecorations);
		fossilMachineTop = new MaemeItem(fossilMachineTopID, "blocks/fossilmachinetop", "Fossil Machine Top").setCreativeTab(CreativeTabs.tabDecorations);
		fossilMachineBase = new MaemeItem(fossilMachineBaseID, "blocks/fossilmachinebase", "Fossil Machine Base").setCreativeTab(CreativeTabs.tabDecorations);
	...
	public static void addNames() {
		if (!isEnabled)
			return;
		try {
			for (Field field : MaemeItemsFossils.class.getFields()) {
